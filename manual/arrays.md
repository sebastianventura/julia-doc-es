...
| Function                           | Description                                                                                                                                                                                                                                  |
|:---------------------------------- |:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`Array{T}(dims...)`](@ref)        | Un [`Array`](@ref) denso no inicializado                                                                                                                                                                                                      |
| [`zeros(T, dims...)`](@ref)        | Un `Array` cuyos elementos son todos ceros                                                                                                                                                                                                                      |
| [`zeros(A)`](@ref)                 | Un array cuyos elementos son todos ceros, con la misma forma y tipos de elementos que `A`                                                                                                                                                                      |
| [`ones(T, dims...)`](@ref)         | Un `Array` cuyos elementos son todos unos                                                                                                                                                                                                                       |
| [`ones(A)`](@ref)                  | Un array cuyos elementos son todos unos, con la misma forma y tipos de elementos que `A`                                                                                                                                                                      |
| [`trues(dims...)`](@ref)           | Un [`BitArray`](@ref) cuyos elementos son todos el valor `true`                                                                                                                                                                                                  |
| [`trues(A)`](@ref)                 | Un `BitArray` cuyos elementos son todos el valor `true` y con la misma forma `A`                                                                                                                                                                                |
| [`falses(dims...)`](@ref)          | Un `BitArray` cuyos elementos son todos el valor `false`                                                                                                                                                                                                         |
| [`falses(A)`](@ref)                | Un `BitArray` cuyos elementos son todos el valor `false` y con la misma forma `A`                                                                                                                                                                               |
| [`reshape(A, dims...)`](@ref)      | Un array que contiene los mismos elementos que `A`, pero con diferentes dimensiones                                                                                                                                                                      |
| [`copy(A)`](@ref)                  | Copia `A`                                                                                                                                                                                                                                     |
| [`deepcopy(A)`](@ref)              | Copia `A`, copiando sus elementos recursivamente                                                                                                                                                                                                   |
| [`similar(A, T, dims...)`](@ref)   | Un array no inicializado del mismo tipo que `A` (denso, *sparse*, etc.), pero con las dimensiones y tipo de elementos especificados. Los argumentos segundo y tercero son ambos opcionales, siendo sus valores por defecto los mismos que los de `A`. |
...
La inversa de las funciones [`sparse()`](@ref) y [`sparsevec`](@ref) es [`findnz()`](@ref), que recupera las entradas utilizadas para crear el array *sparse*. También hay una función [`findn`](@ref) que solo devuelve los vectores índice.
